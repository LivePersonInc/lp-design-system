...
@customElement('lp-fb-quick-reply-question-icon')
export class FbQuickReplyQuestionIcon extends Icon {
  icons = {
    solid: {
      small: SolidSmall,
      medium: SolidMedium,
...
declare global {
  interface HTMLElementTagNameMap {
    "lp-fb-quick-reply-question-icon": FbQuickReplyQuestionIcon,
  }
}
