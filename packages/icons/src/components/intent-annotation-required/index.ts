...
@customElement('lp-intent-annotation-required-icon')
export class IntentAnnotationRequiredIcon extends Icon {
  icons = {
    solid: {
      small: SolidSmall,
      medium: SolidMedium,
...
declare global {
  interface HTMLElementTagNameMap {
    "lp-intent-annotation-required-icon": IntentAnnotationRequiredIcon,
  }
}
